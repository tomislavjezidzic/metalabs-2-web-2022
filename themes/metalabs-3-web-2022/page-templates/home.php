...
<div id="<?= $template_name ?>" class="o-page o-page--<?= $template_name ?>">
    ...
    <div class="o-page__inner o-page__inner--<?= $template_name ?>">
		...
		get_partial( 'slice-partials/modules/text-module', [
			'side_text'   => 'ABOUT  US',
			'title'       => '<span class="u-serif">Just like the artists of the Renaissance</span> we too take pride in crafting the ultimate solutions for our clients.',
		...
		get_partial( 'slice-partials/modules/text-module', [
			'side_text'   => 'SERVICES',
			'title'       => 'We offer the most <span class="u-serif">invigorating</span> web3 solutions and services',
			'description' => '',
		] );
		...
		get_partial( 'slice-partials/modules/text-module', [
			'side_text'   => 'FLOW',
			'title'       => 'Let the space become <span class="u-serif">the canvas</span> for bringing your best ideas to life.',
		...
		get_partial( 'slice-partials/modules/text-module', [
			'side_text'   => 'MANIFESTO',
			'title'       => '<span class="u-serif">The Web3 Renaissance is a paradigm shift</span> that is unfolding before our very eyes wide shut.',
		...
		get_partial( 'slice-partials/modules/text-module', [
			'side_text'   => 'CONTACT',
			'title'       => 'CONTACT<span class="u-serif">Us</span>',
