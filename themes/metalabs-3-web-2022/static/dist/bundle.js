 ...
 */
var CookiePopupController = /*#__PURE__*/function () {
  function CookiePopupController() {
    _classCallCheck(this, CookiePopupController);
    /**
     * DOM Elements
   ...
   * Init
   */
  _createClass(CookiePopupController, [{
    key: "init",
    value: function init() {
      if (_jsCookie.default.get(this.DOM.cookieName) === "true") {
        return;
      }
    ...
    value: function startEvents() {
      ...
      document.addEventListener("afterLoader", function () {
        setTimeout(function () {
          _this.cookiePopup.classList.add(_this.DOM.states.hasNoCookie);
        }, 500);
      });
      var closeButton = this.cookiePopup.querySelector(this.DOM.cookiePopupClose);
      var acceptButton = this.cookiePopup.querySelector(this.DOM.cookiePopupAccept);
      if (closeButton !== null) {
    ...
    value: function setCookie() {
      ...
      _jsCookie.default.set(this.DOM.cookieName, "true", {
        expires: expireTime
      });
    }
  }]);
  return CookiePopupController;
}();
exports.default = CookiePopupController;

},{"js-cookie":"js-cookie"}],6:[function(require,module,exports){
"use strict";
...
},{"gsap":"gsap","gsap/dist/TextPlugin":1}],8:[function(require,module,exports){
"use strict";
...
},{"gsap":"gsap","gsap/dist/ScrollTrigger":"gsap/dist/ScrollTrigger","gsap/dist/SplitText":"gsap/dist/SplitText"}],9:[function(require,module,exports){
"use strict";
...
},{"gsap":"gsap","gsap/dist/ScrollTrigger":"gsap/dist/ScrollTrigger","is_js":"is_js","three":"three","three/examples/jsm/loaders/DRACOLoader":"three/examples/jsm/loaders/DRACOLoader","three/examples/jsm/loaders/GLTFLoader":"three/examples/jsm/loaders/GLTFLoader"}],10:[function(require,module,exports){
"use strict";
...
var Loader = /*#__PURE__*/function () {
  function Loader(afterLoader, midLoader, scrollLock) {
    var _this$logo, _this$logoBox, _this$logoBox2;
    ...
    this.logoBox = (_this$logo = this.logo) === null || _this$logo === void 0 ? void 0 : _this$logo.getBoundingClientRect();
    this.header = document.querySelector(this.DOM.header);
    this.nav = document.querySelector(this.DOM.nav);
    this.topLogoOffset = (_this$logoBox = this.logoBox) === null || _this$logoBox === void 0 ? void 0 : _this$logoBox.top;
    this.leftLogoOffset = (_this$logoBox2 = this.logoBox) === null || _this$logoBox2 === void 0 ? void 0 : _this$logoBox2.left;
  ...
  _createClass(Loader, [{
    ...
    value: function endOfAnimation(animationWrapper) {
      ...
      var x = -(-this.leftLogoOffset - this.additionOffset + animationWrapper.offsetWidth / 2 - this.logoBox.width / 2);
      var y = -(this.topOffset - this.topLogoOffset + animationWrapper.offsetHeight / 2 - this.logoBox.height / 2);
      var scale = 0.69;
      var duration = 0.3;
      ...
      _gsap.default.set([this.logo, this.arrow], {
        autoAlpha: 0
      });
      if (this.subtitle) {
        var split = new _SplitText.SplitText(this.subtitle, {
          type: "words",
          wordsClass: "u-split-text-word"
        });
        _gsap.default.to(split.words, {
          autoAlpha: 0
        });
      ...
      _gsap.default.timeline({
        onStart: function onStart() {
          document.dispatchEvent(_this2.midLoader);
          _this2.wrapper.style.zIndex = "-1";
        }
        ...
        scale: scale,
        duration: duration
      }, "start").add("nav", "start+=0.1").to(this.wrapper, {
        autoAlpha: 0,
        onStart: function onStart() {
          _gsap.default.to(_this2.logo, {
            autoAlpha: 1
          });
        }
      }, "nav+=0.3").fromTo(this.nav, {
        autoAlpha: 0,
        x: this.headerOffset,
        y: this.headerOffset
      }, {
        ...
        ease: "power3.out",
        onStart: function onStart() {
          document.dispatchEvent(_this2.afterLoader);
          _gsap.default.fromTo(subtitleWords, {
            y: "1em",
            autoAlpha: 0
          }, {
            y: "0em",
...
},{"gsap":"gsap","gsap/dist/SplitText":"gsap/dist/SplitText","is_js":"is_js","lottie-web/build/player/lottie_light":"lottie-web/build/player/lottie_light"}],11:[function(require,module,exports){
"use strict";
...
var Marquee = /*#__PURE__*/function () {
  ...
  _createClass(Marquee, [{
    ...
    value: function animateLine(line, direction) {
      ...
      var mover = line.querySelectorAll(".c-marque-module__mover");
      _gsap.default.fromTo(mover, {
        xPercent: start
      }, {
        xPercent: end,
        scrollTrigger: {
...
},{"gsap":"gsap","gsap/dist/ScrollTrigger":"gsap/dist/ScrollTrigger"}],13:[function(require,module,exports){
"use strict";
...
},{"gsap":"gsap","gsap/dist/ScrollSmoother":"gsap/dist/ScrollSmoother","gsap/dist/ScrollTrigger":"gsap/dist/ScrollTrigger"}],14:[function(require,module,exports){
"use strict";
...
},{"is_js":"is_js"}],15:[function(require,module,exports){
"use strict";
...
var _CookiePopupController = _interopRequireDefault(require("./components/CookiePopupController"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/**
 * MAIN JS FILE
 */
...
ready(function () {
  ...
  flicker404.init();
  var cookiePopup = new _CookiePopupController.default();
  cookiePopup.init();
  setTimeout(function () {
    /**
     * Cursor
...
},{"./components/3dSlider":2,"./components/ContactModel":4,"./components/CookiePopupController":5,"./components/Cursor":6,"./components/Flicker404":7,"./components/FlickeringText":8,"./components/HeaderModel":9,"./components/Loader":10,"./components/Marquee":11,"./components/NavigationController":12,"./components/SmoothScroll":13,"./components/Video":14,"./helpers/GridHelper":15,"@bornfight/b-scroll-lock":"@bornfight/b-scroll-lock","@bornfight/b-scroll-to":"@bornfight/b-scroll-to"}]},{},[16])
